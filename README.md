**آموزش وصل شدن به اینترنت آزاد با تونل DNS و Iodine**

این مخزن یک راهنمای کاربردی برای دسترسی به اینترنت آزاد از طریق DNS Tunneling با ابزار Iodine است. در این روش، داده‌ها به‌صورت نام‌های DNS رمزگذاری و ارسال شده و پاسخ‌ها شامل بسته‌های دریافتی‌اند. مرحله به مرحله همراه شو تا تنظیمات را یاد بگیری.
